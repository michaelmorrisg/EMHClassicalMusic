    ...
    render(){
        return(
            <div className="about-main">
                ...
                <p>
                The productions include pieces performed by full orchestras, choir and orchestra, chamber orchestras, string ensembles, string quartets, piano and harpsichord.
                </p>
                <p>
                There is also an entire disc of organ music recorded in Prague’s world famous Rudolfinum Dvorak Concert Hall, featuring such classics as Toccata in Fugue.
                </p>
                <p>
