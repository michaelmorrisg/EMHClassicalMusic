        ...
        return(
            <div className="footer-main">
                <div className="bandcamp">
                    <iframe scrolling="no" style={{paddingLeft: "15px",border: "0",width: "100%",height: "33px"}} src="https://bandcamp.com/band_follow_button_classic/3173216037"></iframe>
                </div>
                <div className="footer-center">
                    <p>Copyright © {new Date().getFullYear()} EMH Classical Music </p>
